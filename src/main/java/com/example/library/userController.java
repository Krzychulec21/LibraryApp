...
public class userController {
    ...
    void zatwierdz(ActionEvent event) {
        ...
        Osoba klonOs = null;
        if (nameField.getText().matches("[a-zA-Z]+") && !nameField.getText().isEmpty() && !nameField.getText().isBlank() &&
                surnameField.getText().matches("[a-zA-Z]+") && !surnameField.getText().isEmpty() && !surnameField.getText().isBlank() && !telField.getText().isBlank() &&
    ...
    void zatwierdzSzukanie(ActionEvent event) {
       ...
       if (imie.matches("[a-zA-Z]+") && nazwisko.matches("[a-zA-Z]+") && tel.matches("[0-9]+")) {
...

                    {
                        ...
                        btnDelete.setOnAction((ActionEvent event) -> {
                            ...
                            try {
                                ...
                                //query.setParameter("dataOddania",null);
                                //query.setParameter("ksiazka","wypozyczona");
                            ...
                            if (stanOs.isEmpty()) {
                                ...
                                if (result.get() == ButtonType.OK) {
                                    ...
                                    //
                                    Session session1 = Connecting.openSession();
